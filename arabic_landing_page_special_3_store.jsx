      ...
      <header className="sticky top-0 z-40 backdrop-blur border-b border-white/10 bg-slate-950/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <a href={STORE_URL} className="flex items-center gap-2 group">
            <div className="size-9 rounded-2xl bg-gradient-to-br from-indigo-500 via-fuchsia-500 to-emerald-500 p-[2px]">
              <div className="h-full w-full rounded-2xl bg-slate-950 grid place-items-center">
                <Sparkles className="size-5 opacity-90 group-hover:rotate-6 transition-transform" />
              </div>
            </div>
